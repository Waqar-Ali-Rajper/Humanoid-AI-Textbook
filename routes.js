...
export default [
  ...
  },
  {
    ...
    routes: [
      {
        path: '/docs',
        component: ComponentCreator('/docs', '614'),
        routes: [
          {
            path: '/docs',
            component: ComponentCreator('/docs', 'c00'),
            routes: [
              {
                path: '/docs/capstone',
                component: ComponentCreator('/docs/capstone', 'd19'),
                exact: true,
              ...
              },
              {
                ...
                component: ComponentCreator('/docs/nvidia-isaac', '53e'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              },
              {
                ...
                component: ComponentCreator('/docs/ros2-basics', 'f73'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/simulation',
                component: ComponentCreator('/docs/simulation', '822'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              {
                path: '/docs/whisper-vla',
                component: ComponentCreator('/docs/whisper-vla', 'fe3'),
                exact: true,
                sidebar: "tutorialSidebar"
              }
            ]
